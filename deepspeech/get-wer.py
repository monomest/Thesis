...
experiment_id = "20211026-base-myST-OGI-TLT-robust-eval-age"
...
train_name = "OGI"
train_filename = "THESIS_C/OGI_data_dev_light"
...
baseline_results_fp = base_fp + train_name + "_local/" + experiment_id + "_OGI_test_baseline_results.csv" 
print("--> baseline_results_fp:", baseline_results_fp)
finetuned_results_fp = base_fp + train_name + "_local/" + experiment_id + "_OGI_test_results.csv"
...
# 3) Load a pre-trained cheadient_checkpointing=set_gradient_checkpointing,
