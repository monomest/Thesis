...
for idx, data_age in enumerate(data_list):
    ...
    # Save results to csv
    results_fp = base_fp + train_name + "_local/" + experiment_id + "_baseline_results" + str(i) + ".csv"
...
for results in results_list:
    print("------ Grade", i, "------")
    print("Baseline WER: {:.3f}".format(wer_metric.compute(predictions=results["pred_str"],
