...
experiment_id = "20211026-base-myST-OGI-TLT-Librispeech-eval-uttlen"
print("experiment_id:", experiment_id)

# DatasetDict Id
# For 1) naming cache directory and 
#     2) saving the DatasetDict object
datasetdict_id = "myST-eval-uttlen"
...
train_name = "myST"
train_filename = "THESIS_C/myST_data_test_uttlen"
...
evaluation_filename = "THESIS_C/myST_data_test_uttlen"
evaluation_age_base = "THESIS_C/myST_data_test_uttlen"
...
checkpoint = "/srv/scratch/z5160268/2020_TasteofResearch/kaldi/egs/renee_thesis/s5/myST-OGI-TLT17_local/20211026-base-myST-OGI-TLT-Librispeech"
if use_checkpoint:
...
baseline_results_fp = base_fp + train_name + "_local/" + experiment_id + "_myST_test_baseline_results.csv" 
print("--> baseline_results_fp:", baseline_results_fp)
finetuned_results_fp = base_fp + train_name + "_local/" + experiment_id + "_myST_test_results.csv"
...
data_list = []
num_grades = 5
for i in range(1, num_grades+1, 1):
...
# 3) Encode the transcription_cleans to label ids
...
for idx, data_age in enumerate(data_list):
    ...
    # Save results to csv
    results_fp = base_fp + train_name + "_local/" + experiment_id + "_myST_test_results" + str(i) + ".csv"
...
print("Group 1: 1 word in utterance")
print("Group 2: 2 to 5 words in utterance")
print("Group 3: 6 to 10 words in utterance")
print("Group 4: 11 to 20 words in utterance")
print("Group 5: 21 words or more in utterance")
i = 0
for results in results_list:
    print("------ Utterance Group", i, "------")
