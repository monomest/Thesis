...
experiment_id = "20211026-base-myST-OGI-TLT-Librispeech-eval"
print("experiment_id:", experiment_id)

# DatasetDict Id
# For 1) naming cache directory and 
#     2) saving the DatasetDict object
datasetdict_id = "TLT-eval"
...
train_name = "TLT"
train_filename = "THESIS_C/TLT17eval_data_test_light"
...
# For generating filepath to file location
evaluation_name = "TLT"
evaluation_filename = "THESIS_C/TLT17eval_data_test_light"
...
baseline_results_fp = base_fp + train_name + "_local/" + experiment_id + "_TLT17_test_baseline_results.csv" 
print("--> baseline_results_fp:", baseline_results_fp)
finetuned_results_fp = base_fp + train_name + "_local/" + experiment_id + "_TLT17_test_results.csv"
