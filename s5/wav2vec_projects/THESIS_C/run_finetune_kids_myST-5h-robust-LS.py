...
experiment_id = "20220505-base-myST-5h-robust-LS"
print("experiment_id:", experiment_id)

# DatasetDict Id
# For 1) naming cache directory and 
#     2) saving the DatasetDict object
datasetdict_id = "myST-5h-finetune"
...
train_name = "myST"
train_filename = "THESIS_C/myST_data_finetune_unk_5h_light"
...
set_num_train_epochs = 166                  # Default = 3.0
...
pretrained_mod = "facebook/wav2vec2-large-robust-ft-libri-960h"
if use_checkpoint:
