...
#pip install jiwer
print("------------------------------------------------------------------------")
print("                 run_finetune_kids_unk.py                               ")
print("------------------------------------------------------------------------")
# ------------------------------------------
...
train_name = "myST"
train_filename = "THESIS_C/myST_data_finetune_unk_noSpkrCol"
