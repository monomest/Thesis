...
OGI_spkrs_train_fp = "/srv/scratch/z5160268/2020_TasteofResearch/kaldi/egs/renee_thesis/s5/OGI_local/OGI_spkrs_scripted_15_subset_10.csv"
# Where to save spkrs test dataframe
OGI_spkrs_test_fp = "/srv/scratch/z5160268/2020_TasteofResearch/kaldi/egs/renee_thesis/s5/OGI_local/OGI_spkrs_scripted_test_15_subset_10.csv"
# Where to save training dataframe
OGI_train_fp = "/srv/scratch/z5160268/2020_TasteofResearch/kaldi/egs/renee_thesis/s5/OGI_local/OGI_scripted_train_15_subset_10.csv"
# Where to save testing
OGI_test_fp = "/srv/scratch/z5160268/2020_TasteofResearch/kaldi/egs/renee_thesis/s5/OGI_local/OGI_scripted_test_15_subset_10.csv"
...
train_all_df = OGI_df[all_spkrs_index.isin(train_spkrs_index)]
#print("train_df:",train_df.head())
# Get all the test rows i.e. speakers NOT in train speakers
test_all_df = OGI_df[~all_spkrs_index.isin(train_spkrs_index)]
