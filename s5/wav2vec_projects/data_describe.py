...
fp_all = "/srv/scratch/z5160268/2020_TasteofResearch/kaldi/egs/renee_thesis/s5/myST_local/myST_dataframe.csv"
...
#    Print message
#-------------------------------------------
print("Describing all valid, transcribed myST data.")
print("File:", fp_all)
...
for fp in fp_list:
    ...
    describeData(df, total_hours, total_samples, total_spkrs)    
