...
# ------------------------------------------
experiment_id = "20210705-short"
datasetdict_id = "20210705-short"
...
#pretrained_mod = "/srv/scratch/z5160268/2020_TasteofResearch/kaldi/egs/renee_thesis/s5/myST_local/wav2vec2-base-myST-20210704/checkpoint-4500"
...
# Run the below commented out code instead, if resuming running from checkpoint
