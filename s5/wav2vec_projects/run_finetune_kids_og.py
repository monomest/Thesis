...
myST_train_fp = "/srv/scratch/z5160268/2020_TasteofResearch/kaldi/egs/renee_thesis/s5/myST_local/myST_train_og.csv"
print("--> myST_train_fp:", myST_train_fp)
# Path to dataframe csv for MyST test
myST_test_fp = "/srv/scratch/z5160268/2020_TasteofResearch/kaldi/egs/renee_thesis/s5/myST_local/myST_test_og.csv"
...
data_cache_fp = "/srv/scratch/z5160268/.cache/huggingface/datasets-og"
print("--> data_cache_fp:", data_cache_fp)
# Path to save vocab.json
vocab_fp = "/srv/scratch/z5160268/2020_TasteofResearch/kaldi/egs/renee_thesis/s5/myST_local/vocab_og.json"
print("--> vocab_fp:", vocab_fp)
# Path to save model output
model_fp = "/srv/scratch/z5160268/2020_TasteofResearch/kaldi/egs/renee_thesis/s5/myST_local/wav2vec2-base-myST-20210705-og"
